...
<div class="min-height-200px">
    ...
    <div class="card shadow">
        ...
        <form @if(empty($coupon->id)) action="{{url('seller/add-edit-coupons')}}" @else action="{{url('seller/add-edit-coupons',$coupon->id)}}" @endif method="POST" class="form_operation" enctype="multipart/form-data">
