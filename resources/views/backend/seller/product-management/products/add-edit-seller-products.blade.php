    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card shadow">
                ...
                <form @if(empty($products->id)) action="{{url('seller/add_edit_products')}}" @else action="{{url('seller/add_edit_products',$products->id)}}" @endif method="POST" class="form_operation" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="long_description" class="form-control" cols="20" rows="5">{{$products->long_description}}</textarea>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="short_description" class="form-control" cols="20" rows="5">{{$products->short_description}}</textarea>
