                ...
                <div class="col-md-6 col-lg-5">
                    <div class="login-box bg-white box-shadow border-radius-10">
                        <div class="login-title">
                            <h2 class="text-center text-primary">Seller Registration</h2>
                        </div>
                        ...
                        <form action="{{route('seller.register')}}" method="post" class="register_form_operation">
                            @csrf
                            ...
                            <div class="input-group custom">
                                <input type="text" class="form-control form-control-lg" placeholder="Enter Your Email" name="email" />
                                <div class="input-group-append custom">
                                    <span class="input-group-text"><i class="icon-copy dw dw-user1"></i></span>
                                </div>
                            ...
                            <div class="input-group custom">
                                <input type="password" class="form-control form-control-lg" placeholder="**********" name="conpassword" />
                                <div class="input-group-append custom">
                                    <span class="input-group-text"><i class="dw dw-padlock1"></i></span>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="input-group mb-0">
                                        ...
                                        <button type="submit" class="btn btn-primary btn-lg btn-block wait-btn">Sign In</button>
                                    </div>
