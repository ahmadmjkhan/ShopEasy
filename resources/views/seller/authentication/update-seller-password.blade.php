...
@section('content')
 ...
 <div class="card card-primary">
     <div class="card-header">
         <h3 class="card-title">Change Seller Password</h3>
     </div>
     <!-- /.card-header -->
     <!-- form start -->
     <form action="{{route('seller.update-password')}}" method="post" class="change_password_form_operation">
         ...
         <div class="card-body">
             <div class="form-group">
                 ...
                 <input type="email" class="form-control" id="exampleInputEmail1" value="{{$sellerdetail['email']}}" readonly>
             </div>
