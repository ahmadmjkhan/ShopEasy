    ...
    <div class="col-lg-5 col-12">
        <div id="auth-left">
            ...
            <form action="{{route('seller.create')}}" method="post" class="seller_login_form_operation">
                ...
                <div class="form-group position-relative has-icon-left mb-4">
                    <input type="text" class="form-control form-control-xl" name="phone" placeholder="Phone" value="{{old('phone')}}">
                    <div class="form-control-icon">
                        <i class="bi bi-envelope"></i>
                    </div>
            ...
            <div class="text-center mt-5 text-lg fs-4">
                <p class='text-gray-600'>Already have an account? <a href="{{route('seller.login')}}" class="font-bold">Log
                        in</a>.</p>
            </div>
        </div>
    </div>
