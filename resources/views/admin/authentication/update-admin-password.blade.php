...
@section('content')
 ...
 <div class="card card-primary">
     ...
     <!-- /.card-header -->
     <!-- form start -->
     <form action="{{route('admin.update-password')}}" method="post" class="change_password_form_operation">
         ...
         <div class="card-body">
             <div class="form-group">
                 ...
                 <input type="email" class="form-control" id="exampleInputEmail1" value="{{$admindetail['email']}}" readonly>
             </div>
