                ...
                <div class="col-lg-9 col-md-8">
                    <div class="header-top-right">
                        <ul class="ht-menu">
                            ...
                            <li>
                                <div class="ht-setting-trigger"><span>Welcome: {{Auth::user()->name}}</span></div>
                                <div class="setting ht-setting">
                                    <ul class="ht-setting-list">
                                        <li><a href="login-register.html">My Account</a></li>
                                        <li>
                            ...
                            <li><a href="#" class="btn btn-sm btn-warning text-white" data-toggle="modal" data-target="#loginModal">Login</a></li>
                            ...
                            <li class="hm-minicart">
                                <div class="hm-minicart-trigger">
                                    ...
                                    <span class="item-text">£80.00
                                        <span class="cart-item-count cart-count">2</span>
                                    </span>
                                </div>
                                <span></span>
                                <div class="minicart">
                    ...
                    <div class="hb-menu">
                        <nav>
                            <ul>
                                ...
                                <!--Category Menu Start-->
                                <li>
                                    <div class="category-menu category-menu-2" style="width:210px;">
                                ...
                                <li class="megamenu-holder"><a href="shop-left-sidebar.html">Shop</a>
                                    <ul class="megamenu hb-megamenu">
                                        @foreach($all_sections as $section)
                                        <li><a href="shop-left-sidebar.html">{{$section->section_name}}</a>
                                            <ul>
