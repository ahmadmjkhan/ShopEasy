            ...
            <div class="col-lg-5 col-md-6">
                ...
                <div class="product-details-left">
                    <div class="product-details-images slider-navigation-1">
                        ...
                        <div class="lg-image"><img src="{{asset('uploads/images/products/multiple-images/large/'.$multiple->images)}}" alt="product image thumb"></div>
                        @endforeach
                    ...
                    <div class="product-details-thumbs slider-thumbs-1 mt-3">
                        ...
                        @foreach($productdetails->multiple_images as $multiple)
                        <div class="sm-image"><img src="{{asset('uploads/images/products/multiple-images/small/'.$multiple->images)}}" alt="product image thumb"></div>
                        @endforeach
            ...
            <div class="col-lg-7 col-md-6">
                ...
                <div class="product-details-view-content sp-sale-content pt-60 product-data">
                    ...
                    <div class="product-info">
                        ...
                        <?php
                        $getDiscountPrice = Products::getDiscountPrice($productdetails->id);
                            ...
                            <div class="single-product-wrap">
                                ...
                                <div class="product_desc">
                                    <div class="product_desc_info">
                                        ...
                                        <?php
                                        $getDiscountPrice = Products::getDiscountPrice($related->id);
