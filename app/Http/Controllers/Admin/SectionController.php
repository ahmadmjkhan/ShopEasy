...
class SectionController extends Controller
{
    public function section_index()
    {
        ...
        return view('admin.sections.section-index', compact('all_section'));
    }
        ...
        if ($request->isMethod('post')) {
            ...
            if ($validator->fails()) {
                ...
                if ($request->hasFile('section_image')) {
                    $path = 'uploads/images/sections/' . $section->section_image;
                    ...
                    $file->move('uploads/images/sections/', $filename);
